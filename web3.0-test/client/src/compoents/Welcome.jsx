      ...
      <div className="flex mf:flex-row flex-col item-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Expoler the crypto world. By and sell cryptocurrencies easily on Krypto.
          </p>
          <button type="button" onClick={connectWallet} className="flex flex-row justify-center items-center my-5 p-3 bg-[#2952e3] rounded-full cursor-pointer hover:bg-[#2546bd]">
            ...
            <div className="flex justify-between flex-col w-full h-full">
              ...
              <div>
                <p className="text-white font-light text-sm">
                  0xdsfkgndfl....123efdsdgf
                </p>
                <p className="text-white font-semiblod text-lg mt-1">
                  Ethereum 
                </p>
              </div>
            </div>
